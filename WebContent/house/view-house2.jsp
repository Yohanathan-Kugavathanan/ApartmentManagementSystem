...
<%@page import="helper.House2Helper,model.House2,controller.*, java.util.ArrayList"%>

<!-- view-house2.jsp. This jsp page allows the user to view all houses' details in the system,
...
<title>List of Houses Page</title>
<link rel="stylesheet"
		...
		<div class="content-wrapper">
				...
				<div class="row mb-2">
					...
					<div class="col-sm-6">
						<ol class="breadcrumb float-sm-right">
							...
							<li class="breadcrumb-item active">List of Houses</li>
						</ol>
					</div>
				</div>
			</div>
			...
			<div class="container-fluid">
				<div class="row">
				 ...
				 <a href="report-house2.jsp"><button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-save-file"></span><i class="fa fa-file-text-o"></i> Generate Reports 
        </button></a>	
				</div>
				<br>
...
<table class="table table-bordered table-responsive"" >
	    ...
	    %>
					...
					<tbody>
								...
								<tr>
									<td><%=house.getH2No() %></td>
									<td><%=house.getH2FloorNo() %></td>
									<td><%=house.getH2NoBeds() %></td>
									<td><%=house.getH2NoBaths() %></td>
									<td><%=house.getH2Sqft() %></td>
									<td><%=house.getH2HouseType() %></td>
									<td><%=house.getH2Status() %></td>
									<td><%=house.getH2Price() %></td>
									<td><%=house.getH2AdvancePayment() %></td>
									<td><%=house.getH2PerMonthRate() %></td>
									<td><%=house.getH2Rent() %></td>
									<td><%=house.getH2GasSupply() %></td>
									<td><%=house.getH2HotWater() %></td>
									
									<td>
									<button class="btn btn-warning" onclick="window.location.href = '<%=request.getContextPath() %>/house/update-house2.jsp?rid=<%=house.getH2No() %>';">Edit</button>
								&nbsp;&nbsp;&nbsp;&nbsp;
								
								<form method="post" action="../DeleteHouse2Controller">

					<input type="hidden" name="h2No" value="<%=house.getH2No()%>">
