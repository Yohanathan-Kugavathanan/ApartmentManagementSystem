...
<!-- add-house2.jsp. This jsp page allows the user to insert houses' details to the system,
...
<title>Add House Details Page</title>
<link rel="stylesheet"
           ...
           <i class="fa fa-angle-left"></i> Back  
			...
			<form method="post" action="../AddHouse2Controller">
					...
					<fieldset class="form-group">
						<label>House No</label> <input class=form-control type="number"
							name="h2No" min="1" max="5" required>
					</fieldset>
					...
					<fieldset class="form-group">
						<label>Price</label><input type="number" class="form-control"
							name="h2Price" min="1" max="15" required>
					</fieldset>

					<fieldset class="form-group">
						<label>Advance Payment / Bond</label><input type="number"
							class="form-control" name="h2AdvancePayment" min="1" max="10" required>
					</fieldset>

					<fieldset class="form-group">
						<label>Per Month Rate</label><input type="number"
							class="form-control" name="h2PerMonthRate" min="1" max="10" required>
					</fieldset>
