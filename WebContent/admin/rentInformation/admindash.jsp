...
<body class="hold-transition sidebar-mini layout-fixed">
	...
	<div class="wrapper">
		...
		<!-- Brand Logo --> <a href="../../index3.html" class="brand-link">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="card card-info">
									...
									<!-- /.card-header -->
									<!-- form start -->
									<form class="form-horizontal" action="../../addAdmin"
										method="POST">
										<div class="card-body">
											...
											<table>
												...
												<tr>
													...
													<td><input type="password" name="password"
														id="myInput" size=50 placeholder="Max 50 characters"
														required></td>
												</tr>
												<tr>
													<td></td>
												...
												<!-- add sent to one , sent to all buttons  -->
