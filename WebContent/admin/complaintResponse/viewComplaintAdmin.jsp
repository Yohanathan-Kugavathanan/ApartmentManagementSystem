...
<meta charset="utf-8">
  ...
  <title>Resident's complaints</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
			...
			<p>
	          ...
	          <li class="nav-item">
            <a href="../rentInformation/addRentInfor.jsp" class="nav-link">
			<p>
                Rent Information
               </p>
            </a>
...
<table class="table table-hover text-nowrap">
		...
		<tr>
			...
			<td><a href="<%=request.getContextPath() %>/admin/complaintResponse/addResponse.jsp?complaintId=<%=complaint.getComplaintId() %>"><b>View</b></a></td>
